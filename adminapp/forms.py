...
class CourseForm(forms.ModelForm):
    class Meta:
        model = Course
        fields = ['title', 'category', 'description']  # Add more fields as needed

class ResourceForm(forms.ModelForm):
    class Meta:
        model = Resource
        fields = ['name', 'file']  # Add fields as needed

# Create the ResourceFormSet
ResourceFormSet = modelformset_factory(Resource, form=ResourceForm, extra=1)  # extra=1 to start with one empty form
