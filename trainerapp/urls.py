...
urlpatterns = [
    ...
    path('meetings/create/', views.create_meeting, name='meeting_create'),
    path('meetings/details', views.meeting_details, name='meeting_details'),
    path('meetings/<int:id>/edit/', views.edit_meeting, name='meeting_edit'),
    path('meetings/<int:id>/delete/', views.delete_meeting, name='meeting_delete'),
